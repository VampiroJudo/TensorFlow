...
def weight_variable(shape, name=None):
    ...
    return tf.Variable(initia, name=name)
...
with tf.name_scope("Conv1")# 32 features for each 5X5 patch of the image
...
#  define number of steps and how often to display progress
num_steps = 3000
display_every = 100
